...
namespace Nestor.Thesaurus
{
    ...
    public enum WordRelation
    {
        ...
        Domain = 16, // область знаний, к котрой принадлежит понятие ("птица" — "зоология", "биология")
        ...
        RelatedAssociation = 4096, // понятие, которое является понятием по отношению к текущему ("птица" — "птичка")
    }
}