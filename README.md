...
Данный проект использует для хранения словоформ ациклический граф с помощью библиотеки [DawgSharp](https://github.com/bzaar/DawgSharp), которая имеет два варианта лицензии: GPL 3.0 и коммерческая.

GPL требует, чтобы «производные произведения» тоже соответствовали условиям GPL. Поэтому если вы используете DawgSharp на условиях GPL, то и Нестор вы тоже должны использовать в рамках GPL.

Если вы приобретете коммерческую лицензию на DawgSharp или напишете свою релизацию Dawg, мою часть кода можете брать по MIT.
